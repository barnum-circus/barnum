...
However, pull requests are not accepted. I use a local AI agent to make changes to this codebase, and dealing with merge conflicts from external PRs is not worth the overhead when it's just as easy to ask my agent to implement the suggested changes directly.
