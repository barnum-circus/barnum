...
const Command = z.discriminatedUnion("kind", [
  z.object({
    ...
    executor: z.string().nullable().optional().describe("Internal: executor command injected by cli.cjs and run.ts. Not user-facing — hidden from --help."),
    ...
    runHandlerPath: z.string().nullable().optional().describe("Internal: path to run-handler.ts, injected by cli.cjs and run.ts. Not user-facing — hidden from --help."),
