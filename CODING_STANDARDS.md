...
- **All tests use rstest with timeouts.** Use `#[rstest]` and `#[timeout(Duration::from_secs(20))]` on every test. Hanging tests should fail quickly, not block CI for 10+ minutes.
