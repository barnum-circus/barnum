...
const LOW_LEVEL_PROTOCOL: &str = include_str!("../../troupe/protocols/LOW_LEVEL_PROTOCOL.md");
const VERSION: &str = env!("TROUPE_VERSION");
...
#[derive(Parser)]
#[command(name = "troupe")]
#[command(about = "Troupe - agent pool for managing workers")]
struct Cli {
