...
const config: Config = {
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'Barnum, programming language, agents, orchestration, workflow, TypeScript, Rust',
      },
      {
        name: 'twitter:card',
      ...
      {
        name: 'twitter:title',
        content: 'Barnum - The programming language for orchestrating agents',
      },
      {
        name: 'twitter:description',
        content: "A programming language for asynchronous programming geared towards orchestrating agents.",
      },
      {
        name: 'twitter:image',
